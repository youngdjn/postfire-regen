...
for(sp in sp.opts) { # about 1 hr per species
      ...
      m[["nP.a0"]] <- brm(bf(response.var ~ ppt.normal_c + ppt.normal_c.sq + (1|Fire),zi ~ ppt.normal_c + ppt.normal_c.sq + (1|Fire)),family=mod.family,data=d.c,iter=2000,control = list(adapt_delta = 0.90),cores=3,chains=3)

...
write.csv(plot,"data_survey/Compiled/Plot_data_full.csv",row.names=FALSE)
write.csv(sapling,"data_survey/Compiled/sapling_regen_full.csv",row.names=FALSE)
write.csv(seedl,"data_survey/Compiled/tree_regen_full.csv",row.names=FALSE)
write.csv(resprout,"data_survey/Compiled/Resprouts_full.csv",row.names=FALSE)
write.csv(surviving.trees,"data_survey/Compiled/surviving_trees_full.csv",row.names=FALSE)
write.csv(seed.tree,"data_survey/Compiled/seed_tree_full.csv",row.names=FALSE)
...
sap <- read.csv("data_survey/Compiled/sapling_regen_full.csv")
#shrub <- read.csv("../data_survey/shrub_regen.csv")
seedl <- read.csv("data_survey/Compiled/tree_regen_full.csv")
resprout <- read.csv("data_survey/Compiled/Resprouts_full.csv")
surviving.trees <- read.csv("data_survey/Compiled/surviving_trees_full.csv",header=TRUE,stringsAsFactors=FALSE)
...
write.csv(regen.ag,"data_intermediate_processing_local/tree_summarized_sp_full.csv",row.names=FALSE)
...
seed.tree <- read.csv("data_survey/Compiled/seed_tree_full.csv",header=TRUE,stringsAsFactors=FALSE)
...
plot.tree.sp <- read.csv("data_intermediate_processing_local/tree_summarized_sp_full.csv",stringsAsFactors=FALSE)
...
write.csv(plot.clim.seedtree.2,"data_intermediate/plot_level_full.csv",row.names=FALSE)
write.csv(plot.3.regen,"data_intermediate/speciesXplot_level_full.csv",row.names=FALSE)
